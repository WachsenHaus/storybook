...
export default function ControllingSelectsWithState() {
  ...
  const [categories, setCategories] = useState([
    ...
    { label: 'Category 2', id: 2, selected: false },
    { label: 'Category 3', id: 3, selected: false },
  ]);

  const [products, setProducts] = useState([
    { label: 'Product 1', id: 1, category: 1, selected: false },
    { label: 'Product 2', id: 2, category: 1, selected: false },
    { label: 'Product 3', id: 3, category: 1, selected: false },
    { label: 'Product 4', id: 4, category: 2, selected: false },
    { label: 'Product 5', id: 5, category: 2, selected: false },
    { label: 'Product 6', id: 6, category: 2, selected: false },
    { label: 'Product 7', id: 7, category: 3, selected: false },
    { label: 'Product 8', id: 8, category: 3, selected: false },
    { label: 'Product 9', id: 9, category: 3, selected: false },
  ]);
  ...
  const onChange = (e) => {
    ...
    const index = collection.findIndex((item) => item.id === e.target.value);
