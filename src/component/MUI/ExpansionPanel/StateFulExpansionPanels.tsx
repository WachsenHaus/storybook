...
const StateFulExpansionPanels: FC = () => {
  StateFulExpansionPanels.displayName = 'dd';
  ...
  return (
    <Fragment>
      {panels
        ...
        .map((panel, index) => (
          <ExpansionPanel key={index} expanded={index === expanded} disabled={panel.disabled} onChange={onChange(index)}>
