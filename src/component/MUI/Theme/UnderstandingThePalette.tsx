...
export type UnderstandingThePalletteTypes = {
  primaryHue: typeof hueOptions;
  primaryShade: number;
};

const UnderstandingThePallette = ({ primaryHue, primaryShade }) => {
  ...
  console.log(hues[primaryHue][primaryShade]); // rgb값이 나옴
