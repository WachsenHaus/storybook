...
const fetchData = () =>
  new Promise<Array<ItemsType>>((resolve) => {
    const items = [
      {
        id: 1,
        name: 'First Item',
...
const MaybeLoading = withStyles(styles)(({ classes, loading }: Props) => (loading ? <CircularProgress className={classes.progress} /> : null));
